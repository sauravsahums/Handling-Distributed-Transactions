...
public class ParticipantService {
    ...
    public boolean prepare(TransactionRequest request) {
        ...
        try {
            ...
            System.out.println("Transaction prepared for request: " + request);
            return true;
        } catch (Exception e) {
            return false;
        }
    ...
    public void commit(TransactionRequest request) {
        ...
        System.out.println("Transaction committed for request: " + request);
    }
    ...
    public void rollback(TransactionRequest request) {
        ...
        System.out.println("Transaction rolled back for request: " + request);
    }
}
